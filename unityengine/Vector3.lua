-- chunkname: @F:/Unity/PascalsWager_steam1/Assets/LuaFramework/ToLua/Lua/UnityEngine/Vector3.lua
...
function Vector3:Set(x, y, z)
	if self.fixed == true then
		SystemHelper.LogError("=========Vector3 fixed error !!! =" .. t)
	end
...
function Vector3:SetFixed(isFixed)
	if self.fixed ~= isFixed then
		self.fixed = isFixed
	end
end

function Vector3:SetVector3(vec)
	if self.fixed == true then
		SystemHelper.LogError("=========Vector3 fixed error !!! =" .. t)
	end
...
function Vector3.DistanceSquare(va, vb)
...
function Vector3.Distance2DSquare(va, vb)
...
Vector3.s_zero = Vector3.NewS(0, 0, 0)
Vector3.s_one = Vector3.NewS(1, 1, 1)
Vector3.s_up = Vector3.NewS(0, 1, 0)
Vector3.s_down = Vector3.NewS(0, -1, 0)
Vector3.s_right = Vector3.NewS(1, 0, 0)
Vector3.s_left = Vector3.NewS(-1, 0, 0)
Vector3.s_forward = Vector3.NewS(0, 0, 1)
Vector3.s_back = Vector3.NewS(0, 0, -1)
