-- chunkname: @f:/unity/pascalswager_steam1/assets/LuaScript/Logic/Trick/TrickGroup10013.lua

require("LuaScript/Logic/Trick/TrickGroupBase")

TrickGroup10013 = class("TrickGroup10013", TrickGroupBase)

function TrickGroup10013:initialize(scene)
...
function TrickGroup10013:Open(pos, rot)
...
function TrickGroup10013:Update()
