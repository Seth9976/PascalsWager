-- chunkname: @f:/unity/pascalswager_steam1/assets/LuaScript/Logic/Trick/TrickGroup10033.lua

require("LuaScript/Logic/Trick/TrickGroupBase")
require("GameData/TrickDefine/TrickGroup10033_Define")

TrickGroup10033 = class("TrickGroup10033", TrickGroupBase)

function TrickGroup10033:initialize(scene)
...
function TrickGroup10033:Open(pos, rot)
...
function TrickGroup10033:Update()
	...
	for i = 1, #self.trickList do
		...
		if self.hitTime[i] == nil or self.hitTime[i] <= 0 then
			...
			if nowTime >= self.hitTime[i] + TrickGroup10033_Define.HitClearTime then
...
function TrickGroup10033:Exit()
	self.hitTime = nil

	TrickGroupBase.Exit(self)
end

return TrickGroup10033
