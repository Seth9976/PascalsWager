-- chunkname: @f:/unity/pascalswager_steam1/assets/LuaScript/Logic/Trick/TrickGroup10034.lua

require("LuaScript/Logic/Trick/TrickGroupBase")
require("GameData/TrickDefine/TrickGroup10034_Define")

TrickGroup10034 = class("TrickGroup10034", TrickGroupBase)

function TrickGroup10034:initialize(scene)
...
function TrickGroup10034:OpenAuto()
	TrickGroupBase.OpenAuto(self)
	self:OpenDelay(TrickGroup10034_Define.DelayTime)
end

function TrickGroup10034:Open(pos, rot)
...
function TrickGroup10034:Update()
	...
	for i = 1, #self.trickList do
		...
		if self.hitTime[i] == nil or self.hitTime[i] <= 0 then
			...
			if nowTime >= self.hitTime[i] + TrickGroup10034_Define.HitClearTime then
...
function TrickGroup10034:Exit()
	self.hitTime = nil

	TrickGroupBase.Exit(self)
end

return TrickGroup10034
