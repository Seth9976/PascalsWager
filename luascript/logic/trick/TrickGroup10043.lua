-- chunkname: @f:/unity/pascalswager_steam1/assets/LuaScript/Logic/Trick/TrickGroup10043.lua

require("LuaScript/Logic/Trick/TrickGroupBase")
require("GameData/TrickDefine/TrickGroup10043_Define")

TrickGroup10043 = class("TrickGroup10043", TrickGroupBase)

function TrickGroup10043:initialize(scene)
...
function TrickGroup10043:Open(pos, rot)
	...
	for i = 1, #self.trickList do
		self.startTime[i] = nowTime + TrickGroup10043_Define.IntervalTime * (i - 1)
...
function TrickGroup10043:Update()
...
function TrickGroup10043:Exit()
	TrickGroupBase.Exit(self)
end

return TrickGroup10043
