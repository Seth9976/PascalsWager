-- chunkname: @f:/unity/pascalswager_steam1/assets/LuaScript/Logic/Trick/TrickGroup10015.lua

require("LuaScript/Logic/Trick/TrickGroupBase")

TrickGroup10015 = class("TrickGroup10015", TrickGroupBase)

function TrickGroup10015:initialize(scene)
...
function TrickGroup10015:Open(pos, rot)
...
function TrickGroup10015:Update()
