-- chunkname: @f:/unity/pascalswager_steam1/assets/LuaScript/Logic/Trick/TrickGroup10012.lua

require("LuaScript/Logic/Trick/TrickGroupBase")

TrickGroup10012 = class("TrickGroup10012", TrickGroupBase)

function TrickGroup10012:initialize(scene)
...
function TrickGroup10012:Open(pos, rot)
...
function TrickGroup10012:Update()
