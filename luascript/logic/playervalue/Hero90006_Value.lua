-- chunkname: @f:/unity/pascalswager_steam1/assets/LuaScript/Logic/PlayerValue/Hero90006_Value.lua

require("LuaScript/Logic/PlayerValue/AnimalBase_Value")

Hero90006_Value = class("Hero90006_Value", AnimalBase_Value)

function Hero90006_Value:initialize(animal)
	AnimalBase_Value.initialize(self, animal)
end

function Hero90006_Value:DamageInstant(attackerData)
...
function Hero90006_Value:DamagePeriod(attackerData)
...
function Hero90006_Value:Exit()
	AnimalBase_Value.Exit(self)
end

return Hero90006_Value
